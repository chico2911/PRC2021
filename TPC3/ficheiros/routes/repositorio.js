    ...
    .then(dados =>{
      ...
      axios.get(getLink + encoded)
        .then(dados => {
          ...
          console.log(classes)
          res.render('repositorio', {rep: rep, prefixo: pre, class1: classes});   
        })
        .catch(err => {
          res.render('error', {error: err});
        });
...
router.get('/:id/classe/:classe', function(req, res, next) {
...
router.get('/:id/classe/:classe/individuo/:ind', function(req, res, next) {
